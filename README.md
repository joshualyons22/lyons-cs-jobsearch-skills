...
Seven interconnected skill files that form the foundation of your Claude-powered job search assistant. Build these in order — each one depends on the ones before it.
